      ...
      <div className="max-w-9/12 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <form className="bg-white shadow-lg rounded-lg p-8 space-y-6">
            ...
            <button
              type="submit"
              className="bg-[#004c4c] text-white px-6 py-2 rounded-md hover:bg-[#006666] transition cursor-pointer"
            >
              Send Message
            </button>
          </form>
          ...
          <div className="flex flex-col justify-center items-start space-y-6">
            <div className="flex items-center text-gray-800 text-md font-bold">
              <FaPhoneAlt className="text-3 text-2xl mr-4" />
            ...
            <div className="rounded-lg overflow-hidden">
              <img
                src="https://i.ibb.co.com/9HfFQ7sX/7442.jpg"
                alt="Contact support"
